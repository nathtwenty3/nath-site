...
function sendToTelegram() {
    ...
    const botToken = "8325372659:AAHFDER6bz0-MbbhvaKRM7WiT3qZLS58Pyw";
    const chatId = "-1003062617687";
    ...
    fetch(`/api/sendMessage`, {
        ...
        .catch(err => {
            ...
            if (!navigator.onLine) {
                userMessage = "⚠️ You appear to be offline. Please check your internet connection.";
            }
